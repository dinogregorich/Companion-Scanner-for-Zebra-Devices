...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new anywheresoftware.b4a.ShellBA(this, null, null, "zebra.companion.scanner", "zebra.companion.scanner.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "zebra.companion.scanner.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
RDebugUtils.currentLine=1179649;
 //BA.debugLineNum = 1179649;BA.debugLine="StartService(scanner)";
anywheresoftware.b4a.keywords.Common.StartService(processBA,(Object)(mostCurrent._scanner.getObject()));
RDebugUtils.currentLine=1179650;
 //BA.debugLineNum = 1179650;BA.debugLine="Log(\"Scanner Service Started\")";
anywheresoftware.b4a.keywords.Common.LogImpl("21179650","Scanner Service Started",0);
RDebugUtils.currentLine=1179651;
 //BA.debugLineNum = 1179651;BA.debugLine="Service.StopAutomaticForeground 'Starter service";
